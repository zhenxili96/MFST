...
class Tracker(object):
  ...
  def track_vot_init(self, sess, first_bbox, frame):
    ...
    self.vot_search_center = np.array([get_center(self.x_image_size),
                              get_center(self.x_image_size)])
    self.vot_current_target_state = TargetState(bbox=bbox,
                                       search_pos=self.vot_search_center,
                                       scale_idx=int(get_center(self.num_scales)))
    
  def track_vot(self, sess, frame):
    bbox_feed = [self.vot_current_target_state.bbox.y, self.vot_current_target_state.bbox.x,
                 self.vot_current_target_state.bbox.height, self.vot_current_target_state.bbox.width]
    input_feed = [frame, bbox_feed]
    ...
    reported_bbox = convert_bbox_format(self.vot_current_target_state.bbox, 'top-left-based')
...
# =============================================================================
#           response_s_c5_max = np.max(response_s_c5)
#           response_s_c4_max = np.max(response_s_c4)
#           response_s_c3_max = np.max(response_s_c3)
#           response_s_c5 = response_s_c5/response_s_c5_max
#           response_s_c4 = response_s_c4/response_s_c4_max
#           response_s_c3 = response_s_c3/response_s_c3_max
# =============================================================================
...
# =============================================================================
# =============================================================================
#           response = 0.3*response_s+0.7*(0.3*response_a_c5+0.6*response_a_c4+0.1*response_a_c3)
# =============================================================================
# =============================================================================
#           response = 0.5*response_s_c5+0.5*response_s_c4+1.0*response_s_c3
# =============================================================================
          response_s_all = 0.7*response_s_c5+0.3*response_s_c4+0.1*response_s_c3
